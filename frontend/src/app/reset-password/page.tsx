    ...
    <div className="auth-page min-h-screen px-6 py-12 text-[#FCF8F6]">
      <div className="mx-auto flex min-h-[calc(100vh-6rem)] max-w-2xl items-center justify-center">
        <Card className="w-full rounded-[40px] border-white/10 bg-[linear-gradient(180deg,rgba(33,26,41,0.9),rgba(20,14,26,0.92))] shadow-[0_20px_80px_rgba(0,0,0,0.38)] backdrop-blur-2xl">
          <CardHeader>
            <CardTitle className="text-4xl text-[#FCF8F6]">Reset password</CardTitle>
          </CardHeader>
          <CardContent className="space-y-5">
            <div className="space-y-2">
              <div className="text-sm text-[#E2C2C6]">Reset token</div>
              <Input
                value={token}
            ...
            <div className="space-y-2">
              <div className="text-sm text-[#E2C2C6]">New password</div>
              <Input
                type="password"
                value={password}
            ...
            <Button onClick={onSubmit} disabled={loading || !token.trim() || !password.trim()} className="w-full rounded-2xl bg-[#F5D547] text-[#0C0910] hover:bg-[#edd031]">
